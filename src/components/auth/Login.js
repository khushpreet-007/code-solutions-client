  ...
  render(){
    return (
      <div className='login d-flex flex-column align-items-center'>
        ...
        <div className='alert alert-warning' style={{width: "100%", textAlign: "center"}}>The requests other than GET are intentionally refused for now, you are only permitted to view the website. Use username=abhishek & password=deathnote for authentication.</div>
